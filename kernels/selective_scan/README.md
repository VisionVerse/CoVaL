# Upstream / original reference

This directory is kept as the original selective-scan kernel reference used by the VMamba/Mamba backbone dependency in `CoVaL`.
It is not a CoVaL-specific module rewrite.
