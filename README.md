...
- t-SNE results across four datasets show that CoVaL separates entangled bi-temporal features (first row) into compact commonality and variation clusters (second row), enabling more discriminative change representation. :point_down: :point_down: :point_down:
<p align="center">
...
- CoVaL produces accurate and structurally consistent change maps, especially in challenging cases with complex backgrounds, small changed regions, and blurred boundaries. :point_down: :point_down: :point_down:
